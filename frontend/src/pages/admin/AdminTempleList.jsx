    ...
    <div>
      <div className="mb-6 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="text-gray-600">Manage temple records and details.</p>
        </div>
      ...
      <div className="mb-4"><SearchBar value={search} onChange={setSearch} placeholder="Search admin temple list" /></div>
                ...
                {(data?.data || []).map((temple) => (
                  <tr key={temple.id} className="border-t border-saffron-100">
                    ...
                    <td className="pr-4 text-right">
                      <Link to={`/admin/temples/${temple.id}/edit`} className="mr-2 inline-grid h-9 w-9 place-items-center rounded border text-saffron-700" title="Edit"><Edit size={16} /></Link>
